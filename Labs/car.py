...
class Car(object):
    ...
    def get_make(self):
        return str(self.__make)
    def get_model(self):
        return str(self.__model)
    def get_mpg(self):
        return float(self.__mpg)
    def get_tank_capacity(self):
        return float(self.__tank_capacity)
    ...
    '''Write a method called get_total_range.
       It returns the total distance the car can travel on a full tank of gas.'''
...
class HybridCar(Car):  
    ...
    def get_battery_kWh(self):
        return float(self.__battery_kWh)
    def get_miles_per_kWh(self):
        return float(self.__miles_per_kWh)
