...
#return fib(n-1) + fib(n-2)
0 read r1       #Get n
1 setn r2 0     #first value of Fibonacci Sequence 
2 setn r3 1     #Second value of Sequence
3 jeqzn r1 10   #if n is 0 do nothing there no output
4 write r2      #Else first write 0
5 add r4 r3 r2  #Then add r3+r2 to get the next value in sequence
6 copy r2 r3    #replace r2 with old r3 in sequence
7 copy r3 r4    # replace r3 with new value r4 (next value in sequence
8 addn r1 -1    #will add -1 until the "counter" is 0 
9 jumpn 3       #Continue the loop
10 halt         #Stop
